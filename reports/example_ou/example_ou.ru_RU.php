...
$LANG['plugin_reports']['example_ou'][1]  = "ПримерКо - статистика по подразделениям" ;
$LANG['plugin_reports']['example_ou'][2]  = "Заявок" ;  // Number of tickets
$LANG['plugin_reports']['example_ou'][3]  = "Номера заявок" ;  // Ticket IDs
